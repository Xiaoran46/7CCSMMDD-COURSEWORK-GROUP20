 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.group20.docker.docker.impl.StopStatementImpl#getContainerName <em>Container Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StopStatementImpl extends StatementsImpl implements StopStatement
{
  /**
  ...
  {
    return DockerPackage.Literals.STOP_STATEMENT;
  }
    ...
    if (containerName != null && containerName.eIsProxy())
    {
      ...
      if (containerName != oldContainerName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DockerPackage.STOP_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
      }
    }
  ...
  public void setContainerName(ContainerNameDeclaration newContainerName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DockerPackage.STOP_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DockerPackage.STOP_STATEMENT__CONTAINER_NAME:

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pause Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.group20.docker.docker.impl.PauseStatementImpl#getContainerName <em>Container Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PauseStatementImpl extends StatementsImpl implements PauseStatement
{
  /**
  ...
  {
    return DockerPackage.Literals.PAUSE_STATEMENT;
  }
    ...
    if (containerName != null && containerName.eIsProxy())
    {
      ...
      if (containerName != oldContainerName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DockerPackage.PAUSE_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
      }
    }
  ...
  public void setContainerName(ContainerNameDeclaration newContainerName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DockerPackage.PAUSE_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DockerPackage.PAUSE_STATEMENT__CONTAINER_NAME:

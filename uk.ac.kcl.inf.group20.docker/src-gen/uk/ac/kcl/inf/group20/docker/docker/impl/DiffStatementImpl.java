...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diff Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.group20.docker.docker.impl.DiffStatementImpl#getContainerName <em>Container Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiffStatementImpl extends StatementsImpl implements DiffStatement
{
  /**
  ...
  {
    return DockerPackage.Literals.DIFF_STATEMENT;
  }
    ...
    if (containerName != null && containerName.eIsProxy())
    {
      ...
      if (containerName != oldContainerName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DockerPackage.DIFF_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
      }
    }
  ...
  public void setContainerName(ContainerNameDeclaration newContainerName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DockerPackage.DIFF_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DockerPackage.DIFF_STATEMENT__CONTAINER_NAME:

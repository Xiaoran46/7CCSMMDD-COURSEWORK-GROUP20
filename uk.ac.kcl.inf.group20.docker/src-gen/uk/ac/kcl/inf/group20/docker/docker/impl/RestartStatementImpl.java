...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Restart Statement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.group20.docker.docker.impl.RestartStatementImpl#getContainerName <em>Container Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RestartStatementImpl extends StatementsImpl implements RestartStatement
{
  /**
   ...
   * @generated
   */
  protected RestartStatementImpl()
  {
    super();
  }
  ...
  {
    return DockerPackage.Literals.RESTART_STATEMENT;
  }
    ...
    if (containerName != null && containerName.eIsProxy())
    {
      ...
      if (containerName != oldContainerName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DockerPackage.RESTART_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
      }
    }
  ...
  public void setContainerName(ContainerNameDeclaration newContainerName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DockerPackage.RESTART_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DockerPackage.RESTART_STATEMENT__CONTAINER_NAME:

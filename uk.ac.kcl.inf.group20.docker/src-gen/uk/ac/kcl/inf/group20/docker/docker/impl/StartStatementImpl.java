 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.group20.docker.docker.impl.StartStatementImpl#getContainerName <em>Container Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StartStatementImpl extends StatementsImpl implements StartStatement
{
  /**
  ...
  {
    return DockerPackage.Literals.START_STATEMENT;
  }
    ...
    if (containerName != null && containerName.eIsProxy())
    {
      ...
      if (containerName != oldContainerName)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, DockerPackage.START_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
      }
    }
  ...
  public void setContainerName(ContainerNameDeclaration newContainerName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DockerPackage.START_STATEMENT__CONTAINER_NAME, oldContainerName, containerName));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DockerPackage.START_STATEMENT__CONTAINER_NAME:
